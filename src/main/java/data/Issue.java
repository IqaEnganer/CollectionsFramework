...
public class Issue implements List<Issue> {
    ...
    public boolean equals(Object o) {
        ...
        Issue issue = (Issue) o;
        return id == issue.id && number == issue.number && howManyDaysAgoWasItCreated == issue.howManyDaysAgoWasItCreated && close == issue.close && Objects.equals(author, issue.author) && Objects.equals(topic, issue.topic) && Objects.equals(assignee, issue.assignee) && Objects.equals(tags, issue.tags) && Objects.equals(text, issue.text);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, number, author, topic, assignee, tags, text, howManyDaysAgoWasItCreated, close);
    }
